...
function A:UpdateHeader(header)
	...
	while child do
		...
		child.CooldownText:SetFont("Interface\\AddOns\\NDui\\Media\\ROADWAY.TTF", 18, DB.Font[3]) -- 时间：字体路径,数字是大小，后面是阴影
...
function A:CreateAuraIcon(button)
	...
	button.count:SetFont("Interface\\AddOns\\NDui\\Media\\ROADWAY.TTF", 15, DB.Font[3]) -- 叠层：字体路径,数字是大小，后面是阴影
	...
	text:SetFont("Interface\\AddOns\\NDui\\Media\\ROADWAY.TTF", 18, DB.Font[3]) -- 时间：字体路径,数字是大小，后面是阴影
